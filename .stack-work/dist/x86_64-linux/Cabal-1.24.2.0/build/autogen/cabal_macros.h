...
/* package prestige-0.1.0.0 */
#define VERSION_prestige "0.1.0.0"
#define MIN_VERSION_prestige(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "prestige-0.1.0.0-BDERk6gCVSNGNpilZEiY5c"

#define CURRENT_PACKAGE_KEY "prestige-0.1.0.0-BDERk6gCVSNGNpilZEiY5c"
